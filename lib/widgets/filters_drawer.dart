                          ...
                          child: SafeArea(
                            child: Column(
                              ...
                              children: [
                                ...
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: List.generate(matchTypes.length, (
                                    index,
                                  ) {
                                    final type = matchTypes[index];
                                    final isSelected = value.filters.contains(
                                      type.name,
                                    );
                                    return Padding(
                                      padding: EdgeInsets.only(bottom: 16.h),
                                      child: GestureDetector(
                                        onTap: () => value.addFilter(type.name),
                                        child: Container(
                                          decoration: BoxDecoration(
                                            gradient: AppTheme.blackGradient,
                                            border: Border.all(
                                ...
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: List.generate(victoryTypes.length, (
                                    index,
                                  ) {
                                    final isSelected = value.filters.contains(
                                      victoryTypes[index],
